...
void CKT::GFX::GfxObject::_SetScale(float sx, float sy)
{
	if (sx > 0)
		m_ScaleX = sx;
...
void CKT::GFX::GfxObject::SetScale(float s)
{
	_SetScale(s, s);
}

void CKT::GFX::GfxObject::SetScale(float sx, float sy)
{
	_SetScale(sx, sy);
}

void CKT::GFX::GfxObject::SetScaleX(float sx)
{
	_SetScale(sx, m_ScaleY);
}

void CKT::GFX::GfxObject::SetScaleY(float sy)
{
	_SetScale(m_ScaleX, sy);
}

CKT::GFX::GfxObject::GfxObject()
{
...
int CKT::GFX::GfxObject::Init(PRENDERER ren, PTEXTURE tex, float x, float y, float s)
{
	m_Texture = tex;
...
int CKT::GFX::GfxObject::Init(PRENDERER ren, std::string file, float x, float y, float s)
{
	// texture
...
int CKT::GFX::GfxObject::Init(PRENDERER ren, std::string file, float x, float y, float w, float h, float s)
{
	Init(ren, file, x, y, s);
...
int CKT::GFX::GfxObject::Init(PRENDERER ren, std::string file, float x, float y, int xTiles, int yTiles, float s)
{
	Init(ren, file, x, y, s);
	m_Width /= xTiles;
	m_Height /= yTiles;
...
int CKT::GFX::GfxObject::Init(PRENDERER ren, std::string file, float x, float y, int xTiles, int yTiles, SDL_Rect clip, float s)
{
...
void CKT::GFX::GfxObject::ResetAnimation()
{
	m_AnimStep = 0;
	m_AnimStepX = 0;
	m_AnimStepY = 0;
...
int CKT::GFX::GfxObject::PlayAnimation(int beginn, int end, int speed, bool loop)
{
	int ret = 1;
...
int CKT::GFX::GfxObject::PlayAnimation(int beginn, int end, int speed, int timesPlay)
{
	int ret = 0;
