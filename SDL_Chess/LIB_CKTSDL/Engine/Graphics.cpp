...
void CKT::GFX::DrawRect(PRENDERER ren, float x, float y, float w, float h, SDL_Color col)
{
	SDL_SetRenderDrawBlendMode(ren, SDL_BlendMode::SDL_BLENDMODE_BLEND);
	SDL_SetRenderDrawColor(ren, col.r, col.g, col.b, col.a);
	SDL_Rect rDst = { (int)x, (int)y, (int)w, (int)h };
	SDL_RenderDrawRect(ren, &rDst);
}

void CKT::GFX::FillRect(PRENDERER ren, float x, float y, float w, float h, SDL_Color col)
{
	SDL_SetRenderDrawBlendMode(ren, SDL_BlendMode::SDL_BLENDMODE_BLEND);
	SDL_SetRenderDrawColor(ren, col.r, col.g, col.b, col.a);
	SDL_Rect rDst = { (int)x, (int)y, (int)w, (int)h };
	SDL_RenderFillRect(ren, &rDst);
}
