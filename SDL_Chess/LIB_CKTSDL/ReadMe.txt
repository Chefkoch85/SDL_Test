========================================================================
    DYNAMIC LINK LIBRARY: LIB_CKTSDL-Projektübersicht
========================================================================

Diese LIB_CKTSDL-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LIB_CKTSDL-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LIB_CKTSDL.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
