...
int CKT::GUI::CSimpleScrollbarVer::Init(PRENDERER ren, float x, float y, float w, float h)
{
	m_pRenderer = ren;
	...
	m_btnPrev.w = (int)m_Height;
	m_btnPrev.h = (int)m_Height;

	m_btnNext.w = (int)m_Height;
	m_btnNext.h = (int)m_Height;

	m_btnTrack.w = (int)m_Height;
	m_btnTrack.h = (int)m_Height;
...
{
	m_btnPrev.x = (int)m_PosX;
	m_btnPrev.y = (int)m_PosY;

	m_btnNext.x = (int)m_Width - m_btnNext.h + (int)m_PosX;
	m_btnNext.y = (int)m_PosY;

	m_btnTrack.x = (int)m_PosX + m_btnPrev.w + 20;
	m_btnTrack.y = (int)m_PosY;
