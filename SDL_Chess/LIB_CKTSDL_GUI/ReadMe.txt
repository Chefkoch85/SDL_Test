========================================================================
    DYNAMIC LINK LIBRARY: LIB_CKTSDL_GUI-Projektübersicht
========================================================================

Diese LIB_CKTSDL_GUI-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LIB_CKTSDL_GUI-Anwendung besteht.


LIB_CKTSDL_GUI.vcxproj
...
LIB_CKTSDL_GUI.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LIB_CKTSDL_GUI.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
